...
def _gather_clone_loss(clone, num_clones, regularization_losses):
  ...
  with tf.device(clone.device):
    ...
    print(clone.scope)
    hash_distance_mean = tf.get_collection('hash_distance_mean_losses', clone.scope)
    if hash_distance_mean:
      hash_distance_mean = tf.add_n(hash_distance_mean, name='hash_distance_mean')
      all_losses.append(hash_distance_mean)
    hash_distance_max = tf.get_collection('hash_distance_max_losses', clone.scope)
    if hash_distance_max:
      hash_code_max = tf.add_n(hash_distance_max, name='hash_distance_max')
      # all_losses.append(hash_code_max)
    hash_distance_min = tf.get_collection('hash_distance_min_losses', clone.scope)
    if hash_distance_min:
      hash_code_min = tf.add_n(hash_distance_min, name='hash_distance_min')
      # all_losses.append(hash_code_min)
    hash_code_out_diag_mean = tf.get_collection('hash_code_diag_mean_losses', clone.scope)
    if hash_code_out_diag_mean:
      hash_code_out_diag_mean = tf.add_n(hash_code_out_diag_mean, name='hash_code_out_diag_mean')
      # all_losses.append(hash_code_out_diag_mean)
  ...
  if hash_distance_mean is not None:
    tf.summary.scalar(clone.scope + '/hash_distance_mean', hash_distance_mean)
  if hash_distance_max is not None:
    tf.summary.scalar(clone.scope + '/hash_distance_max', hash_code_max)
  if hash_distance_min is not None:
    tf.summary.scalar(clone.scope + '/hash_distance_min', hash_code_min)
  if hash_code_out_diag_mean is not None:
    tf.summary.scalar(clone.scope + '/hash_code_out_diag_mean', hash_code_out_diag_mean)
