...
def get_network_fn(name, num_classes, hash_code_num, weight_decay=0.0, is_training=False):
  ...
  def network_fn(images, **kwargs):
    ...
    with slim.arg_scope(arg_scope):
      return func(images, num_classes, hash_code_num, is_training=is_training, **kwargs)
